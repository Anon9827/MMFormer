...
echo "Creating conda environment 'MMFormer' with Python 3.9..."
conda create -n MMFormer python=3.9 -y

echo "Initializing conda..."
eval "$(conda shell.bash hook)"

echo "Activating the 'MMFormer' environment..."
conda activate MMFormer
